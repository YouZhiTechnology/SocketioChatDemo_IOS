...
@protocol ChatAudioPlayerHelperDelegate <NSObject>
...
@interface ChatAudioPlayerHelper : NSObject

//播放代理
@property (nonatomic, weak) id <ChatAudioPlayerHelperDelegate> delegate;
//当前播放的标示
