//
//  ChatMessageLocationViewController.m
//  SHChatUI
//
...
@interface ChatMessageLocationViewController ()<MKMapViewDelegate,UIAlertViewDelegate> {
    //地图
    MKMapView *_mapView;
    //定位
...
@implementation ChatMessageLocationViewController
...
- (void)viewDidLoad {
    ...
    switch (self.locType) {
        case ChatMessageLocationType_Location://定位
        {
            ...
            self.message = [[ChatMessage alloc]init];
        }
            break;
        case ChatMessageLocationType_Look://查看
        {
            //右上角
            ...
            ChatLocation *location = [[ChatLocation alloc]init];
...
- (void)initMapUI{
    ...
    if (self.locType == ChatMessageLocationType_Location) {//定位
...
- (MKAnnotationView *)mapView:(MKMapView *)mapView viewForAnnotation:(id<MKAnnotation>)annotation{
    ...
    // 设置大头针颜色
    annotationView.pinTintColor = [UIColor systemRedColor];
