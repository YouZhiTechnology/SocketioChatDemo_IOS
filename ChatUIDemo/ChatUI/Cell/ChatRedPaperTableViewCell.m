...
#import "ChatRedPaperTableViewCell.h"

@interface ChatRedPaperTableViewCell ()
...
@implementation ChatRedPaperTableViewCell
...
- (void)setMessageFrame:(ChatMessageFrame *)messageFrame{
    ...
    self.redPaperImage.image = [ChatFileHelper imageNamed:@"chat_red"];
    if (message.isReceive) {
        ...
        self.redPaperImage.image = [ChatFileHelper imageNamed:@"chat_red_receive"];
    }
