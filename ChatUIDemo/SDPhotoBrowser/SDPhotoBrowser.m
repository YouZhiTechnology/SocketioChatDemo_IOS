...
- (void)setupToolbars
{
    ...
    [saveButton setTitleColor:UIColor.darkTextColor forState:UIControlStateNormal];
...
- (void)layoutSubviews
{
    ...
    int buttonWidth = (self.bounds.size.width - 200)/2;

    _saveButton.frame = CGRectMake(buttonWidth, self.bounds.size.height - 110, 200, 48);
}
