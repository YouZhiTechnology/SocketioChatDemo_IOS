//
//  UIImageView+ChatExtension.m
//  ChatExtensionExample
//
//  Created by CChat on 2018/9/20.
//  Copyright © 2018年 CChat. All rights reserved.
//

#import "UIImageView+ChatExtension.h"

@implementation UIImageView (ChatExtension)
...
- (CGRect)getImageFrame{
    ...
    // Divide the size by the greater of the vertical or horizontal Chatrinkage factor
